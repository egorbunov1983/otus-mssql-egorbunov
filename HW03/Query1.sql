...
Select YEAR([InvoiceDate]) as 'Год продажи', MAX(MONTH([InvoiceDate])) as 'Месяц продажи',
...
*/
Use [WideWorldImporters];
Select YEAR([InvoiceDate]) as 'Год продажи', MAX(MONTH([InvoiceDate])) as 'Месяц продажи',[Description] as 'Наименование товара',
